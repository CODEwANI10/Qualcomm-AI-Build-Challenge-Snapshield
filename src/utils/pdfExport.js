...
export async function generateCERTInReport(incident) {
  ...
  doc.text('SnapShield', 12, 13)
  doc.setFontSize(7)
  doc.setFont('helvetica', 'normal')
  doc.setTextColor(...GRAY)
  doc.text('ON-DEVICE NETWORK THREAT INTELLIGENCE · QUALCOMM AI HUB · HEXAGON NPU', 12, 19)
  doc.setFont('helvetica', 'bold')
  doc.setFontSize(9)
  ...
  doc.setFontSize(6.5)
  doc.setTextColor(...GRAY)
  doc.text('SnapShield On-Device Intelligence · Confidential · For CERT-In Use Only', 105, 290, { align: 'center' })
  doc.text(`Document ID: ${incId} · Powered by Llama 3.2 3B — Qualcomm AI Hub · Hexagon NPU`, 105, 295, { align: 'center' })

  const filename = `SnapShield_${incId}_CERT-In_Report.pdf`
  doc.save(filename)
  return filename
}
