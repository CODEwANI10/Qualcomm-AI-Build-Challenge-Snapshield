...
export function exportIncidentsJSON(incidents) {
  const payload = {
    ...
    system:      'SnapShield v2.0 — On-Device Network Intelligence',
  ...
  const a    = Object.assign(document.createElement('a'), { href:url, download:`SnapShield-incidents-${Date.now()}.json` })
