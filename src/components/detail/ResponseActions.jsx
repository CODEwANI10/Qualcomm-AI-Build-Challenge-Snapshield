      ...
      {isMit ? (
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 8, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            {isDemo
              ? "Same real, RFC-format artifacts SnapShield would generate for a live incident — shown here against this simulated attack."
              : 'These are real, RFC-format artifacts SnapShield generated automatically via Llama 3.2 3B on the Hexagon NPU. Deploying them requires a human network operator.'}
          </div>
        </div>
      )}
